...
def main(ctx):
  ...
  # OSX
  osx_cxx("B2_TOOLSET=clang B2_CXXSTD=14,17 Job 23", "g++", packages="", buildscript="drone", buildtype="boost", environment={'B2_TOOLSET': 'clang', 'B2_CXXSTD': '14,17', 'DRONE_JOB_UUID': 'd435a6cdd7'}, globalenv=globalenv),
